...
% \documentclass{book} % You can adjust this to your specific document class

% Include necessary packages
% \usepackage[utf8]{inputenc}
% \usepackage[T1]{fontenc}
% \usepackage{biblatex} % or whatever package you are using for bibliography
% \addbibresource{references.bib} % Assuming you have a .bib file for references
% \usepackage{hyperref}
...
% \pagestyle{fancy}
% \fancyhead{}
% \fancyhead[L]{\leftmark} % Set chapter title in the header on the left
...
%\chapter{Wie Schwimmt man am Besten durch den Fluss?\label{chapter:schwimmen}}
%\kopflinks{Thema}
%\begin{refsection}
...
%\end{itemize}
%
%\input{papers/schwimmen/teil0.tex}
%\input{papers/schwimmen/teil1.tex}
%\input{papers/schwimmen/teil2.tex}
...
% Einen Fluss zu überqueren ist nicht neues, das war schon sein anbeging der Menschheit ein Problem. Offt auch im zusammenhang wie man am besten über einen Fluss kommt mit einem Boot. 
% Einpaar simple ansätze die man sich überlegen könnte währen um einen Fluss am besten zu überqueren wären. Ihn an einer Stelle zu überqueren wo er nicht tief ist so das man hinüber laufen kann oder oder einfach gemütlich hinüber schwimmen und zulassen das die strömmung einem mitziht. 

% Nun ist die Frage aber wie überquere ich am besten einen Fluss, was in diesemm Fall am kleinsten Energie verbrauch gemessen wird. In Abbildung \ref{fig:river_original} ist ein solcher Fluss für die überquerung abebildet




% Des weiteren ist definiert das man auf gleicher Höhe des Flusses auf der anderen Seite ankommen sollte. Sihe Abbildung \ref{fig:river_points}. Die fage ist wie schwimmt man am Besten von A nach B.


% In diesem Kapitel soll nun erläutert werden wie man mitels des Variationsprinzips die Beste schwimmrute über den Fluss findet.
