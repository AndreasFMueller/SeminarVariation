...
Es werden auch hier nur die Einträge ungleich null sein, deren Elemente sich wie in Abbildung \ref{fem:nd:formfkt} gezeigt berühren.
Der Eintrag in der Zeile $a$ und Spalte $b$ ist also nur dann ungleich Null, wenn Element $a$ und Element $b$ im Graphen \ref{fem:nd:2d_mesh} verbunden sind.

\subsection{Codieren der Anfangsbedingungen}
Beim Codieren von Dirichlet-Randbedingung 
\footnote{Randbedingungen, bei denen Werte am Rand des Definitionsbereichs vorgegeben sind}
unterscheidet sich das Vorgehen nicht von dem des im Kapitel \ref{fem:1d:anfangsbedingung} beschriebenen eindimensionalen Fall. 
...
Hier unterscheidet sich das Vorgehen nicht vom im Kapitel \ref{fem:1d:matrix_invertieren} behandelten eindimensionalen Fall.