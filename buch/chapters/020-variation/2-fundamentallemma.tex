...
ist aus der Forderung, dass alle Richtungsableitungen verschwinden müssen, 
...
oft stetig differenzierbare Funktionen gibt, die nur in einem beliebig
...
\end{equation}
für jede beliebig oft stetig differenzierbare Funktion $\varphi(x)$ 
gilt, dann ist $f(x)=0$.
...
\begin{definition}[Quadratintegrierbare Funktion]
\index{quadratintegrierbar}%
...
Stetige Funktionen auf einem kompakten Interval sind
quadratintegrierbar.
...
\begin{definition}[$L^2$-Skalarprodukt, $L^2$-Norm]
