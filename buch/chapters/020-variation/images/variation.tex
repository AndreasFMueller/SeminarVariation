...
\node[color=blue] at (2.0,1.3)
	[rotate=-53] {$(x_1(\varepsilon),y_1(\varepsilon))$};
\node[color=blue] at (9.0,1.7)
	[rotate=80] {$(x_2(\varepsilon),y_2(\varepsilon))$};
...
\draw ({x(1,0)},{Y(x(1,0),0)}) -- +(\l,{\l*ry(1,0)/rx(1,0)})
	-- ({x(1,0)+\l},{Y(x(1,0),0)});
\node at ({x(1,0)+1.5},{Y(x(1,0),0)+0.06}) [below] {$\delta x_2$};
\draw[color=darkred,line width=1.2pt] ({x(1,0)},{Y(x(1,0),0)})
	-- +(\l,{\l*deltay(x(1,0),0)})
	-- ({x(1,0)+\l},{Y(x(1,0),0)});
\node[color=darkred] at ({x(1,0)+\l},{Y(x(1,0),0)+0.45})
	[right] {$\displaystyle\frac{\partial y}{\partial x}\cdot\delta x_2$};
