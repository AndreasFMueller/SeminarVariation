...
mögliche Lösung eines Anfangs\-kurve-End\-kurve-Problems mit Anfangskurve
...
Gesucht ist daher eine Methode, die die Integrationskonstanten zu bestimmen
...
\vec{r}_1(\alpha)
=
\frac{d}{d\alpha}\gamma_1(\alpha)
\qquad\text{und}\qquad
\vec{r}_2(\beta)
=
\frac{d}{d\beta}\gamma_2(\beta)
\]
...
\]
bei.
Das zu minimierende Funktional ist daher
\[
I(y)
=
\int_{-l}^l
